...
class TribunJatengSpider(scrapy.Spider):
    name = "malang_tribun"
    allowed_domains = [ 'suryamalang.tribunnews.com' ]
    page_url = 'https://suryamalang.tribunnews.com/index-news?date='
    start_urls = [
        'https://suryamalang.tribunnews.com/index-news?date=2020-3-15'
    ]
