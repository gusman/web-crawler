...
class TribunJatengSpider(scrapy.Spider):
    name = "pontianak_tribun"
    allowed_domains = [ 'pontianak.tribunnews.com' ]
    page_url = 'https://pontianak.tribunnews.com/index-news?date='
    start_urls = [
        'https://pontianak.tribunnews.com/index-news?date=2020-3-15'
    ]
