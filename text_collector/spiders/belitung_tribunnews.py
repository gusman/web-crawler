...
class TribunJatengSpider(scrapy.Spider):
    name = "belitung_tribun"
    allowed_domains = [ 'belitung.tribunnews.com' ]
    page_url = 'https://belitung.tribunnews.com/index-news?date='
    start_urls = [
        'https://belitung.tribunnews.com/index-news?date=2020-3-15&page=1'
    ]
