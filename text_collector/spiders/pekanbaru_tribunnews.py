...
class TribunJatengSpider(scrapy.Spider):
    name = "pekanbaru_tribun"
    allowed_domains = [ 'pekanbaru.tribunnews.com' ]
    page_url = 'https://pekanbaru.tribunnews.com/index-news?date='
    start_urls = [
        'https://pekanbaru.tribunnews.com/index-news?date=2020-3-15&page=1'
    ]
