...
class TribunJatengSpider(scrapy.Spider):
    name = "banjarmasin_tribun"
    allowed_domains = [ 'banjarmasin.tribunnews.com' ]
    page_url = 'https://banjarmasin.tribunnews.com/index-news?date='
    start_urls = [
        'https://banjarmasin.tribunnews.com/index-news?date=2020-3-15&page=1'
    ]
