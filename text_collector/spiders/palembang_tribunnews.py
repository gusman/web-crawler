...
class TribunJatengSpider(scrapy.Spider):
    name = "palembang_tribun"
    allowed_domains = [ 'palembang.tribunnews.com' ]
    page_url = 'https://palembang.tribunnews.com/index-news?date='
    start_urls = [
        'https://palembang.tribunnews.com/index-news?date=2020-3-15&page=1'
    ]
